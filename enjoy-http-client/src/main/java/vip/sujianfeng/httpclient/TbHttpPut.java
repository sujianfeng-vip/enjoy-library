...
public class TbHttpPut {
    ...
    public TbHttpResponse<String> put(String url, Map<String, String> headers, Map<String, String> params, Object bodyObj, String contentType) {
    ...
    public TbHttpResponse<String> put(String url, Map<String, String> headers, Object bodyObj) {
        return put(url, headers, new HashMap<>(), bodyObj, TbHttpEntriryRequest.CONTENT_TYPE_APPLICATION_JSON);
    }

    public TbHttpResponse<String> put(String url, Object bodyObj) {
        return put(url, null, bodyObj);
    }

    public TbHttpResponse<String> put(String url) {
